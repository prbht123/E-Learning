...
class ContentListView(View):
    def get(self, request):
        print("0000")
        content = Content.objects.filter(module__course__owner=request.user)
        print(content.values())
        data={}
        data['data']=content.values()
        #return redirect('courses:courses/manage/content/list.html',content)
        return render(request, 'courses/manage/content/list.html', context=data)
...
class CourseListView(TemplateResponseMixin, View):
    ...
    def get(self, request, subject=None):
        ...
        if not subjects:
            bjects = Subject.objects.annotate(total_courses=Count('courses'))
